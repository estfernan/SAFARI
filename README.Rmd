...
Examples are provided for the main functions. One may get started from those examples and the function documentation.
...
We also provide a command-line tool for applications in the terminal and an online tool available at <https://lce.biohpc.swmed.edu/safari/>.
